...
export default {
  ...
  methods : {
    ...
    async requestHttp() {
        try {
          await fetch(`https://capabff.fat60.qa.nt.ctripcorp.com/capabff`).then(res => {
            return res.json
          })
          let data = (
            await axios.get(`https://capabff.fat60.qa.nt.ctripcorp.com/capabff`, {
              headers: {
